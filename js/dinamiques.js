	  ...
	  Expand, Search,Home,BasemapGallery,GeometryService,ProjectParameters,Bookmarks, TimeSlider, Portal,PortalBasemapsSource,IdentifyTask,IdentifyParameters, arrayUtils, domConstruct,on, dom, all) {
		...
		var anompp19Layer = new MapImageLayer({
		  ...
		  var anomppGroupLayer = new GroupLayer({
			...
			visible: true,
			visibilityMode: "independent",
			layers: [anompp17Layer, anompp18Layer, anompp19Layer],
			opacity: 1
		  });
		  ...
		  var anomtempGroupLayer = new GroupLayer({
			...
			visible: true,
			visibilityMode: "independent",
			layers: [anomtmp16Layer, anomtmp17Layer, anomtmp18Layer, anomtmp19Layer],
			opacity: 1
		  });
		...
		// Funcionalitat del paisatge	
		 ...
		 //Estat ecologic 
		  ...
		  var genresidusmuni10Layer = new MapImageLayer({
			portalItem: {
				id: "6d28cbf1bedc4613961aed7900a274ce"
			},
			id: "",
			visible: false,
			title: lresidumuni10,
		...
		capes.push(genresidusmuni10Layer);


		  var genresidusmuni11Layer = new MapImageLayer({
			portalItem: {
				id: "fb3c01bd732e4894bae73c9edbdce50e"
			},
			id: "",
			visible: false,
			title: lresidumuni11,
		...
		capes.push(genresidusmuni11Layer);
		 
		  var genresidusmuni12Layer = new MapImageLayer({
			portalItem: {
				id: "1b281cffbe474fefb5cb6f50bea75c78"
			},
			id: "",
			visible: false,
			title: lresidumuni12,
		...
		capes.push(genresidusmuni12Layer);
		 
		  var genresidusmuni13Layer = new MapImageLayer({
			portalItem: {
				id: "a1308238fd9a409196a5aacf5ee78789"
			},
			id: "",
			visible: false,
			title: lresidumuni13,
		...
		capes.push(genresidusmuni13Layer); 
		 
		  var genresidusmuni14Layer = new MapImageLayer({
			portalItem: {
				id: "a40650b3dad642a3ae6157b502ef8542"
			},
			id: "",
			visible: false,
			title: lresidumuni14,
		...
		capes.push(genresidusmuni14Layer);  
		...
		capes.push(genresidusmuni15Layer); 
		  ...
		  var genresidusmuni16Layer = new MapImageLayer({
			portalItem: {
		...
		capes.push(genresidusmuni16Layer);

		var residusmuniGroupLayer = new GroupLayer({
			title: gResidusmuni,
			visible: true,
			visibilityMode: "independent",
			layers: [genresidusmuni10Layer, genresidusmuni11Layer, genresidusmuni12Layer, genresidusmuni13Layer, genresidusmuni14Layer, genresidusmuni15Layer, genresidusmuni16Layer],
			opacity: 1
		});
	
		//Residus per habitants
		var genresidushabi13Layer = new MapImageLayer({
			portalItem: {
				id: "b6dd570b4edc4786a7b9634075aa9b31"
			},
			id: "",
			visible: false,
			title: lgeneresiduhabi13,
			listMode: "hide-children"
		});
		capes.push(genresidushabi13Layer);
		
		var genresidushabi14Layer = new MapImageLayer({
			portalItem: {
				id: "063aef07167c4222839c9e0a729a7ba9"
			},
			id: "",
			visible: false,
			title: lgeneresiduhabi14,
			listMode: "hide-children"
		});
		capes.push(genresidushabi14Layer);
		
		var genresidushabi15Layer = new MapImageLayer({
			portalItem: {
				id: "e6d8c6dcbf3048d986f0084a5bd3088d"
			},
			id: "",
			visible: false,
		...
		var residushabiGroupLayer = new GroupLayer({
			...
			visible: true,
			visibilityMode: "independent",
			layers: [genresidushabi13Layer, genresidushabi14Layer, genresidushabi15Layer, genresidushabi16Layer],
			opacity: 1
		});
		...
		var generacioresidusGroupLayer = new GroupLayer({
		  ...
		  var indsocioecoGroupLayer = new GroupLayer({
			...
			visible: true,
			visibilityMode: "independent",
			layers: [generacioresidusGroupLayer, consumAiguaGroupLayer, consumEnergGroupLayer, ecoGroupLayer, funcionalitatGroupLayer, actvegetacGroupLayer, 
		...
		var poblacio20Layer = new MapImageLayer({
		  ...
		  var demoGroupLayer = new GroupLayer({
			...
			visible: true,
			visibilityMode: "independent",
			layers: [densitat15Layer, densitat20Layer, poblacio15Layer, poblacio20Layer],
			opacity: 1
		  });
		...
		var rendabaixa15Layer = new MapImageLayer({
		  ...
		  var ambest_rendaGroupLayer = new GroupLayer({
			...
			visible: true,
			visibilityMode: "independent",
			layers: [ambest_raltGroupLayer, ambest_rintGroupLayer, ambest_rbaixaGroupLayer, indeginiGroupLayer, origenrendaGroupLayer],
			opacity: 1
		  });
...
//joves sense qualificacio
	...
	capes.push(joves15Layer);
		...
		var socioGroupLayer = new GroupLayer({
          ...
          visible: true,
          visibilityMode: "independent",
          layers: [sociopatentsGroupLayer, habitatgeGroupLayer, migraGroupLayer, envellimentGroupLayer, 
			istGroupLayer, aturGroupLayer, pibGroupLayer, ambest_rendaGroupLayer, formacioGroupLayer, demoGroupLayer],
          opacity: 1
        });
