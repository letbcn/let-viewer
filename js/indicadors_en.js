/*****************************************************************
        ...
        renderer_A1= {
          ...
          field: "a1a_c_0",
          legendOptions: {
            title: "Energy efficiency (EFEROI)"
          },
          defaultSymbol: {
            type: "simple-fill", 
            style: "none",
        ...
        renderer_A3= {
          ...
          field: "a1c_c_0",
          legendOptions: {
            title: "Biomass appropriation (HANPPact)"
          },
          defaultSymbol: {
            type: "simple-fill", 
            style: "none",
		...
		renderer_B = {
          ...
          field: "b1_c_0",
          legendOptions: {
            title: "Conservation of biodiversity (ELIA)"
          },
          defaultSymbol: {
            type: "simple-fill", 
            style: "none",
		...
		renderer_D = {
          ...
          field: "d1_c_0",
          legendOptions: {
            title: "Climate change (t CO₂ eq/ha)"
          },
          defaultSymbol: {
            type: "simple-fill", 
            style: "none",
		...
		renderer_E1A = {
          ...
          field: "e1a_c_0",
          legendOptions: {
            title: "Nutrient recirculation (% rP)"
          },
          defaultSymbol: {
            type: "simple-fill", 
            style: "none",
		...
		renderer_E1C = {
          ...
          field: "e1c_c_0",
          legendOptions: {
            title: "Agricultural production (kg ms)"
          },
          defaultSymbol: {
            type: "simple-fill", 
            style: "none",
		...
		renderer_dif_F = {
		 ...
		 function canvi(weightListIndicators, value){
			...
			case "A1":
				...
				renderer_dif_A1.legendOptions.title = "Difference between current scenario and optimized scenario (EFEROI)";
				...
				renderer_dif_A1.legendOptions.title = "Difference between the trend scenario and the optimized scenario (EFEROI)";
			...
			case "A2":
				...
				renderer_dif_A2.legendOptions.title = "Difference between current scenario and optimized scenario (ETR)";
				...
				renderer_dif_A2.legendOptions.title = "Difference between the trend scenario and the optimized scenario (ETR)";
			...
			case "A3":
				...
				renderer_dif_A3.legendOptions.title = "Difference between current scenario and optimized scenario (HANPPact)";
				...
				renderer_dif_A3.legendOptions.title = "Difference between the trend scenario and the optimized scenario (HANPPact)";
			...
			case "B": 
				...
				renderer_dif_B.legendOptions.title = "Difference between current scenario and optimized scenario (ELIA)";
				...
				renderer_dif_B.legendOptions.title = "Difference between the trend scenario and the optimized scenario (ELIA)";
			...
			case "C": 
				...
				renderer_dif_C.legendOptions.title = "Difference between current scenario and optimized scenario (Le)";
				...
				renderer_dif_C.legendOptions.title = "Difference between the trend scenario and the optimized scenario (Le)";
			...
			case "D": 
				...
				renderer_dif_D.legendOptions.title = "Difference between current scenario and optimized scenario (t CO₂ eq/ha)";
				...
				renderer_dif_D.legendOptions.title = "Difference between the trend scenario and the optimized scenario (t CO₂ eq/ha)";
			...
			case "E1A": 
				...
				renderer_dif_E1A.legendOptions.title = "Difference between current scenario and optimized scenario (% rP)";
				...
				renderer_dif_E1A.legendOptions.title = "Difference between the trend scenario and the optimized scenario (% rP)";
			...
			case "E1B": 
				...
				renderer_dif_E1B.legendOptions.title = "Difference between current scenario and optimized scenario (t C)";
				...
				renderer_dif_E1B.legendOptions.title = "Difference between the trend scenario and the optimized scenario (t C)";
			...
			case "E1C": 
				...
				renderer_dif_E1C.legendOptions.title = "Difference between current scenario and optimized scenario (kg ms)";
				...
				renderer_dif_E1C.legendOptions.title = "Difference between the trend scenario and the optimized scenario (kg ms)";
			...
			case "F": 
				...
				renderer_dif_F.legendOptions.title = "Difference between current scenario and optimized scenario (UTA)";
				...
				renderer_dif_F.legendOptions.title = "Difference between the trend scenario and the optimized scenario (UTA)";
		...
		function queryLayerViewStats(capa,weightListIndicators) 
		{
			...
			capa.queryFeatures().then(function(response) {	
				...
				let indicatorA1Obj = new MaxSumMultipleIndicator("Energy efficiency (A1A)", "ratio between the energy produced by crops and the energy they consume", 2, valorsMaxA1, valorsMaxA1_2, valorsA1_actual, valorsA1_2_actual, valorsA1_tend, valorsA1_2_tend, valorsOptA1, valorsOptA1_2);
				let indicatorA2Obj = new MinSumIndicator("Water consumption (A1B)", "hm³", 0, valorsMinA2, valorsA2_actual, valorsA2_tend, valorsOptA2);
				indicatorA2Obj.setFactor(0.001);
				let indicatorA3Obj = new MinSumMultipleIndicator("Biomass appropriation (A1C)", "% of HANPP", 0, valorsMinA3, valorsMinA3_2, valorsA3_actual, valorsA3_2_actual, valorsA3_tend, valorsA3_2_tend, valorsOptA3, valorsOptA3_2);
				indicatorA3Obj.setFactor(100);
				let indicatorBObj = new MaxAvgIndicator("Conservation of biodiversity (B1)", "energy-information-landscape ratio index", 2, valorsMaxB, valorsB_actual, valorsB_tend, valorsOptB);
				let indicatorCObj = new MaxAvgIndicator("Landscape operation (C1)", "landscape complexity index", 2, valorsMaxC, valorsC_actual, valorsC_tend, valorsOptC);
				let indicatorDObj = new MinSumIndicator("Climate change (D1)", "thousands of tons of CO₂ eq/ha", 2, valorsMinD1, valorsD_actual, valorsD_tend, valorsOptD1);
				indicatorDObj.setFactor(0.001);
				let indicatorE1AObj = new MaxSumMultipleIndicator("Nutrient recirculation (E1A)", "% of phosphorous recirculation", 0, valorsMaxE1A1, valorsMaxE1A2, valorsE1A1_actual, valorsE1A2_actual, valorsE1A1_tend, valorsE1A2_tend, valorsOptE1A1, valorsOptE1A2);
				indicatorE1AObj.setFactor(100);
				let indicatorE1BObj = new MaxSumIndicator("Carbon stock (E1B)", "million tons of carbon", 3, valorsMaxE1B, valorsE1B_actual, valorsE1B_tend, valorsOptE1B);
				indicatorE1BObj.setFactor(0.000001);
				let indicatorE1CObj = new MaxSumIndicator("Agricultural production (E1C)", "thousands of tons of dry material", 0, valorsMaxE1C1, valorsE1C_actual, valorsE1C_tend, valorsOptE1C1);
				indicatorE1CObj.setFactor(0.000000001);
				let indicatorFObj = new MaxSumIndicator("Work places (F1)", "UTAs", 0, valorsMaxF1, valorsF_actual, valorsF_tend, valorsOptF1);
