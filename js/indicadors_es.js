/*****************************************************************
        ...
        renderer_A1= {
          ...
          field: "a1a_c_0",
          legendOptions: {
            title: "Eficiencia energética (EFEROI)"
          },
          defaultSymbol: {
            type: "simple-fill", 
            style: "none",
        ...
        renderer_A3= {
          ...
          field: "a1c_c_0",
          legendOptions: {
            title: "Apropiación de biomasa (HANPPact)"
          },
          defaultSymbol: {
            type: "simple-fill", 
            style: "none",
		...
		renderer_B = {
          ...
          field: "b1_c_0",
          legendOptions: {
            title: "Conservación de la biodiversidad (ELIA)"
          },
          defaultSymbol: {
            type: "simple-fill", 
            style: "none",
		...
		renderer_C = {
          ...
          field: "c1_c_0",
          legendOptions: {
            title: "Funcionamiento del paisaje (Le)"
          },
          defaultSymbol: {
            type: "simple-fill", 
            style: "none",
		...
		renderer_D = {
          ...
          field: "d1_c_0",
          legendOptions: {
            title: "Cambio climático (t CO₂ eq/ha)"
          },
          defaultSymbol: {
            type: "simple-fill", 
            style: "none",
		...
		renderer_E1A = {
          ...
          field: "e1a_c_0",
          legendOptions: {
            title: "Recirculación de nutrientes (% rP)"
          },
          defaultSymbol: {
            type: "simple-fill", 
            style: "none",
		...
		renderer_E1C = {
          ...
          field: "e1c_c_0",
          legendOptions: {
            title: "Producción agrícola (kg ms)"
          },
          defaultSymbol: {
            type: "simple-fill", 
            style: "none",
		...
		renderer_dif_F = {
		 ...
		 function canvi(weightListIndicators, value){
			...
			case "A1":
				...
				renderer_dif_A1.legendOptions.title = "Diferencia entre el escenario actual y el escenario optimizado (EFEROI)";
				...
				renderer_dif_A1.legendOptions.title = "Diferencia entre el escenario tendencial y  el escenario optimizado (EFEROI)";
			...
			case "A2":
				...
				renderer_dif_A2.legendOptions.title = "Diferencia entre el escenario actual y el escenario optimizado (ETR)";
				...
				renderer_dif_A2.legendOptions.title = "Diferencia entre el escenario tendencial y  el escenario optimizado (ETR)";
			...
			case "A3":
				...
				renderer_dif_A3.legendOptions.title = "Diferencia entre el escenario actual y el escenario optimizado (HANPPact)";
				...
				renderer_dif_A3.legendOptions.title = "Diferencia entre el escenario tendencial y  el escenario optimizado (HANPPact)";
			...
			case "B": 
				...
				renderer_dif_B.legendOptions.title = "Diferencia entre el escenario actual y el escenario optimizado (ELIA)";
				...
				renderer_dif_B.legendOptions.title = "Diferencia entre el escenario tendencial y  el escenario optimizado (ELIA)";
			...
			case "C": 
				...
				renderer_dif_C.legendOptions.title = "Diferencia entre el escenario actual y el escenario optimizado (Le)";
				...
				renderer_dif_C.legendOptions.title = "Diferencia entre el escenario tendencial y  el escenario optimizado (Le)";
			...
			case "D": 
				...
				renderer_dif_D.legendOptions.title = "Diferencia entre el escenario actual y el escenario optimizado (t CO₂ eq/ha)";
				...
				renderer_dif_D.legendOptions.title = "Diferencia entre el escenario tendencial y  el escenario optimizado (t CO₂ eq/ha)";
			...
			case "E1A": 
				...
				renderer_dif_E1A.legendOptions.title = "Diferencia entre el escenario actual y el escenario optimizado (% rP)";
				...
				renderer_dif_E1A.legendOptions.title = "Diferencia entre el escenario tendencial y  el escenario optimizado (% rP)";
			...
			case "E1B": 
				...
				renderer_dif_E1B.legendOptions.title = "Diferencia entre el escenario actual y el escenario optimizado (t C)";
				...
				renderer_dif_E1B.legendOptions.title = "Diferencia entre el escenario tendencial y  el escenario optimizado (t C)";
			...
			case "E1C": 
				...
				renderer_dif_E1C.legendOptions.title = "Diferencia entre el escenario actual y el escenario optimizado (kg ms)";
				...
				renderer_dif_E1C.legendOptions.title = "Diferencia entre el escenario tendencial y  el escenario optimizado (kg ms)";
			...
			case "F": 
				...
				renderer_dif_F.legendOptions.title = "Diferencia entre el escenario actual y el escenario optimizado (UTA)";
				...
				renderer_dif_F.legendOptions.title = "Diferencia entre el escenario tendencial y  el escenario optimizado (UTA)";
		...
		function queryLayerViewStats(capa,weightListIndicators) 
		{
			...
			capa.queryFeatures().then(function(response) {	
				...
				let indicatorA1Obj = new MaxSumMultipleIndicator("Eficiencia energetica (A1A)", "ratio entre la energía producida por los cultivos y la energía que consumen", 2, valorsMaxA1, valorsMaxA1_2, valorsA1_actual, valorsA1_2_actual, valorsA1_tend, valorsA1_2_tend, valorsOptA1, valorsOptA1_2);
				let indicatorA2Obj = new MinSumIndicator("Consumo de agua (A1B)", "hm³", 0, valorsMinA2, valorsA2_actual, valorsA2_tend, valorsOptA2);
				indicatorA2Obj.setFactor(0.001);
				let indicatorA3Obj = new MinSumMultipleIndicator("Apropiación de biomasa (A1C)", "% de HANPP", 0, valorsMinA3, valorsMinA3_2, valorsA3_actual, valorsA3_2_actual, valorsA3_tend, valorsA3_2_tend, valorsOptA3, valorsOptA3_2);
				indicatorA3Obj.setFactor(100);
				let indicatorBObj = new MaxAvgIndicator("Conservación de la biodiversidad (B1)", "índice de relación energía-información-paisaje", 2, valorsMaxB, valorsB_actual, valorsB_tend, valorsOptB);
				let indicatorCObj = new MaxAvgIndicator("Funcionamiento del paisaje (C1)", "índice de complejidad paisajística", 2, valorsMaxC, valorsC_actual, valorsC_tend, valorsOptC);
				let indicatorDObj = new MinSumIndicator("Cambio climático (D1)", "miles de toneladas de CO₂ eq/ha", 2, valorsMinD1, valorsD_actual, valorsD_tend, valorsOptD1);
				indicatorDObj.setFactor(0.001);
				let indicatorE1AObj = new MaxSumMultipleIndicator("Recirculación de nutrientes (E1A)", "% de recirculación de fósforo", 0, valorsMaxE1A1, valorsMaxE1A2, valorsE1A1_actual, valorsE1A2_actual, valorsE1A1_tend, valorsE1A2_tend, valorsOptE1A1, valorsOptE1A2);
				indicatorE1AObj.setFactor(100);
				let indicatorE1BObj = new MaxSumIndicator("Stock de carbono (E1B)", "millones de toneladas de carbono", 3, valorsMaxE1B, valorsE1B_actual, valorsE1B_tend, valorsOptE1B);
				indicatorE1BObj.setFactor(0.000001);
				let indicatorE1CObj = new MaxSumIndicator("Producción agrícola (E1C)", "miles de toneladas de materia seca", 0, valorsMaxE1C1, valorsE1C_actual, valorsE1C_tend, valorsOptE1C1);
				indicatorE1CObj.setFactor(0.000000001);
				let indicatorFObj = new MaxSumIndicator("Lugares de trabajo (F1)", "UTAs", 0, valorsMaxF1, valorsF_actual, valorsF_tend, valorsOptF1);
